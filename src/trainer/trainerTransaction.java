...
public class trainerTransaction extends javax.swing.JFrame {
   
    public trainerTransaction(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(trainerTransaction.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new trainerTransaction().setVisible(true);
            }
        });
    }

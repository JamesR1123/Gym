...
public class editTrainer extends javax.swing.JFrame {
    ...
    public editTrainer(String id, String firstname, String lastname, String phone, String email, String birthdate) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Edit Trainer Information");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        // Check if email exists for another trainer
        try {
            Connection conn = config.connectDB();
            String checkEmail = "SELECT T_id FROM tbl_trainers WHERE T_email = ? AND T_id <> ?";
            ...
            if (rs.next()) {
                JOptionPane.showMessageDialog(this, "This email is already used by another trainer!");
                pstCheck.close();
                conn.close();
                return;
            }
            ...
            // Update DB
            String sql = "UPDATE tbl_trainers SET " +
                         "T_firstname = ?, " +
                         "T_lastname = ?, " +
                         "T_phone = ?, " +
                         "T_email = ?, " +
